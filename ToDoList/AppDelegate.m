...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    id <TDHandlesMOC> child = (id <TDHandlesMOC>)self.window.rootViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.coursera.ToDoList" in the application's documents directory.
